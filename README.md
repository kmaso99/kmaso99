...
**📈 [Quanta Multi‑Signal Equity Strategy (Flagship)](https://github.com/kmaso99/quanta-multi-signal-equity-strategy)**
50-signal systematic equity strategy with disciplined **TRAIN → VALIDATION → LOCKED → HOLDOUT** workflow.
...
**✈️ [Aerospace + Security Data Analyses](https://github.com/kmaso99/aerospace-data)**
Notebooks transforming raw aerospace/security datasets into interpretable insights.
